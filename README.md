...
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.200.localNames.de", "Extramager")
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.300.localNames.de", "Mager")
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.400.localNames.de", "Standard")
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.500.localNames.de", "Mittel")
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.600.localNames.de", "Halbfett")
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.700.localNames.de", "Fett")
fontforgeVF.setVFValue(fontCL, "axes.wght.labels.800.localNames.de", "Extrafett")
